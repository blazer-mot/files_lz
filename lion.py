...
for paragraph in lion.paragraphs:
    text.append(paragraph.text) #добавлякм весь наш текст в раннее созданную переменную
...
#фильтруем текст, оставляем только маленькие буквы
